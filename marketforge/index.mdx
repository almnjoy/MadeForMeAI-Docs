...
<iframe
  ...
  src="https://www.youtube.com/embed/Q2wnAheNqRw?list=PLRYD-6CZQyDA"
  title="Market Forge"
  frameBorder="0"
...
Three videos, in the order they are worth watching. The player above starts on the first
and the rest are in the same playlist.

<CardGroup cols={3}>
  <Card title="The tour - 1:40" icon="play" href="https://youtu.be/Q2wnAheNqRw">
    What the desk is and what every tab does, narrated end to end in one take.
  </Card>
  <Card title="It will not press send - 2:19" icon="hand" href="https://youtu.be/3jalTccK5eg">
    Two minutes from a real pre-market session: the brief, the plan, the staged ticket,
    and the refusal.
  </Card>
  <Card title="A live trade - 6:27" icon="chart-line" href="https://youtu.be/y60QIhaU3Vk">
    The whole unscripted session the short cut came from, chaptered. Real account,
    real order.
  </Card>
</CardGroup>

The two session videos are one morning on a real $1,000 account. Nothing staged,
nothing re-shot.
